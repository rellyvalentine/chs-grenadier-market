    ...
    return (
        <VStack gap={8} p={4} h="full" w="full">
            ...
            <VStack w="full" h="full" gap={3} alignItems="start" borderRadius={4}>
                <HStack w="full" gap={4} p={3} borderRadius={16} bg="primary.100" border="2px solid" borderColor="primary.400" _hover={{ cursor: "pointer" }}>
                    <Icon as={FaClipboardCheck} color="primary.600" size="lg" />
                    <Link href="/admin/orders" textDecoration="none" color="primary.600">
                        <Text fontSize="md" fontWeight="700" lineHeight="25px" textTransform="uppercase">Orders</Text>
                    </Link>
                </HStack>
                <HStack w="full" gap={4} p={3} borderRadius={16} bg={props.current === "analytics" ? "primary.100" : "auto"} _hover={{ bg: "#EDEEF1", cursor: "pointer" }}>
                ...
                <HStack w="full" gap={4} p={3} borderRadius={16} bg={props.current === "inventory" ? "primary.100" : "auto"} _hover={{ bg: "#EDEEF1", cursor: "pointer" }}>
                ...
                <HStack w="full" gap={4} p={3} borderRadius={16} bg={props.current === "users" ? "primary.100" : "auto"} _hover={{ bg: "#EDEEF1", cursor: "pointer" }}>
                    ...
                    <HStack w="full" gap={4} p={3} borderRadius={16} bg={props.current === "settings" ? "primary.100" : "auto"} _hover={{ bg: "#EDEEF1", cursor: "pointer" }}>
